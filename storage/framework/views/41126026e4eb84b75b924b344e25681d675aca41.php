    ...
    <div class="row">
        ...
        <div class="col-12 col-md-9">
            <div class="w-lg-90 ml-auto">
                <form class="text-dark" method="POST" action="<?php echo e(route('product-types.update', $productType->id)); ?>"
                    enctype="multipart/form-data">

                    <div class="form-group">
                        <label class="mb-0" for="product_type">Prodcut Type*</label>
                        <input type="text"
                            class="form-control <?php $__errorArgs = ['product_type'];
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            value="<?php echo e(old('product_type') ?? $productType->name); ?>">
...
unset($__errorArgs, $__bag); ?>" name="shop"
                            id="shop">
                            <option value="">Choose Shop</option>
                            <?php $__currentLoopData = $shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($shop->id); ?>" <?php if($shop->id == old('shop')): ?> selected <?php elseif($shop->id ==
                                $productType->shop_id): ?> selected <?php endif; ?> > <?php echo e($shop->name); ?> </option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pange\Desktop\mart\resources\views/product-types/edit.blade.php ENDPATH**/ ?>