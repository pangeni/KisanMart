...
unset($__errorArgs, $__bag); ?>" name="username"
                id="username" type="text" placeholder="Username" value="<?php echo e(old('username')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="d-flex mt-2">
            <a class="link-secondary" href="<?php echo e(route('register')); ?>">Register</a>
            <a class="link-secondary ml-auto" href="http://127.0.0.1:8080/apex/f?p=101:LOGIN_DESKTOP:1234310620859:::::">Admin login</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pange\Desktop\mart\resources\views/auth/login.blade.php ENDPATH**/ ?>