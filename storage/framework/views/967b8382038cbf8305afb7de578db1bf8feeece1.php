...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="carousel-img" src="<?php echo e(asset('assets/images/first-banner.jpg')); ?>" alt="Banner 1">
        </div>
        ...
        <div class="carousel-item">
            <img class="carousel-img" src="<?php echo e(asset('assets/images/third-banner.jpg')); ?>" alt="Banner 3">
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pange\Desktop\hudders-market\resources\views/landing.blade.php ENDPATH**/ ?>