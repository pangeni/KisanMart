...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="carousel-img" src="{{ asset('assets/images/first-banner.png') }}" alt="Banner 1">
        </div>
        ...
        <div class="carousel-item">
            <img class="carousel-img" src="{{ asset('assets/images/third-banner.png') }}" alt="Banner 3">
        </div>
    </div>
