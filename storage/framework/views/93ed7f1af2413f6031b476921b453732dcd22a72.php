    ...
    <div class="row">
        ...
        <div class="col-12 col-md-9">
            <div class="w-lg-90 ml-auto">
                <form method="post" class="text-dark" action="<?php echo e(route('shops.update', $shop->id)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            value="<?php echo e(old('shop_name') ?? $shop->name); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-4 mb-2">
                        <img width="100"
                            src="<?php echo e($shop->image ? asset($shop->image) : asset('assets/images/thumbnail.png')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pange\Desktop\mart\resources\views/shops/edit.blade.php ENDPATH**/ ?>