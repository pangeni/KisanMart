    ...
    <div class="row">
        ...
        <div class="col-12 col-md-9">
            <div class="w-lg-90 ml-auto">
                <form class="text-dark" action="<?php echo e(route('products.update', $product->id)); ?>" method="post"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select <?php $__errorArgs = ['product_type_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php else: ?> border-text <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <option value="<?php echo e($productType->id); ?>" <?php if($productType->id == old('product_type_id')): ?>
                                selected <?php elseif($productType->id == $product->product_type_id): ?> selected <?php endif; ?>>
                                <?php echo e($productType->name); ?> </option>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            placeholder="Product Description"><?php echo e(old('description') ?? $product->description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="price"
                                name="price" placeholder="Product Price" value="<?php echo e(old('price') ?? $product->price); ?>">
...
unset($__errorArgs, $__bag); ?>" id="stock"
                                name="stock" placeholder="Product Stock" value="<?php echo e(old('stock') ?? $product->stock); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="number"
                                class="form-control <?php $__errorArgs = ['minimum'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php else: ?> border-text <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('minimum') ?? $product->minimum); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col">
                            ...
                            <input type="number"
                                class="form-control <?php $__errorArgs = ['maximum'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php else: ?> border-text <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('maximum') ?? $product->maximum); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control <?php $__errorArgs = ['allergy_info'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php else: ?> border-text <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            placeholder="unit Information"><?php echo e(old('allergy_info') ?? $product->allergy_info); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select <?php $__errorArgs = ['discount_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php else: ?> border-text <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            id="discount_id" name="discount_id" value="<?php echo e(old('discount_id')); ?>">
                            ...
                            <option value="<?php echo e($discount->id); ?>" <?php if($discount->id == old('discount_id')): ?> selected
                                <?php elseif($discount->id == ($product->discount->first() ? $product->discount->first()->id
                                : null)): ?> selected <?php endif; ?>> <?php echo e($discount->name); ?> </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pange\Desktop\Sanjay\mart\resources\views/products/edit.blade.php ENDPATH**/ ?>