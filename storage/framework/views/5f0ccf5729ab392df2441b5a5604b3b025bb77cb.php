...
<body class="bg-light">
    ...
    <div class="container-fluid bg-white py-2">
        <div class="container d-flex align-items-center">
            <a href="<?php echo e(url('')); ?>">
                <img height="50" src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Organic Mart Logo">
            </a>

            <form action="<?php echo e(route('search')); ?>" class="input-group ml-3 ml-lg-5">
                <input type="text" name="q" value="<?php echo e($search ?? ''); ?>"
                    class="form-control border-2 border-primary shadow-none" placeholder="Search in Kisan Market">
    ...
    <!-- Sub Navigation Bar -->
    <div class="container-fluid py-2 bg-secondary lg-max-hide">
        <div class="container">
    ...
    <div class="bg-secondary mt-5 py-4">
        <div class="container">
            <div class="row">
                <div class="col-12 mb-2 mb-lg-0 col-md-4 d-flex align-items-center">
                    <a href="<?php echo e(url('/')); ?>">
                        <img width="250" class="img-fluid" src="<?php echo e(asset('assets/images/logo.png')); ?>"
                            alt="Kisan Mart Logo">
                    </a>
                </div>
                ...
                <div class="col-12 mt-2 mt-lg-0 col-md-4">
                    ...
                    <a class="d-block link-footer" href="#">Call: 014382867</a>
                    <a class="d-block link-footer" href="mailto:kisanmart@gmail.com">
                        Email: kisanmart@gmail.com</a>
    ...
    <p class="bg-primary text-white text-center py-2 mb-0">Kisan Mart © 2022 | All Rights Reserved.</p>
    ...
    <div class="container-fluid bg-white border py-2 fixed-bottom position-sticky lg-hide">
        <div class="row">
            ...
            <div class="col-3">
                <a class="link-text" href="<?php echo e(route('products.index')); ?>">
                    <div class="text-center footer-menu-item">
                        <i class="fas fa-th"></i>
...
<?php /**PATH C:\Users\pange\Desktop\Sanjay\mart\resources\views/layouts/app.blade.php ENDPATH**/ ?>