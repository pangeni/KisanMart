...
<body class="bg-light">
    ...
    <div class="container-fluid bg-white py-2">
        <div class="container d-flex align-items-center">
            <a href="{{ url('') }}">
                <img height="50" src="{{ asset('assets/images/logo.png') }}" alt="Organic Mart Logo">
            </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 mb-2 mb-lg-0 col-md-4 d-flex align-items-center">
                    <a href="{{ url('/') }}">
                        <img width="250" class="img-fluid" src="{{ asset('assets/images/logo.png') }}"
                            alt="Kisan Mart Logo">
                    </a>
                </div>
    ...
    <div class="container-fluid bg-white border py-2 fixed-bottom position-sticky lg-hide">
        <div class="row">
            ...
            <div class="col-3">
                <a class="link-text" href="{{ route('products.index') }}">
                    <div class="text-center footer-menu-item">
                        <i class="fas fa-th"></i>
