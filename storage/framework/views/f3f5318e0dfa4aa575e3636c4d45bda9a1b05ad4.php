...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-12 col-lg-3">
            ...
            <!-- Side Navigation -->
            <?php echo $__env->make('layouts.sidebar', ['addDiscount' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="col-12 col-md-9">
            <div class="w-lg-90 ml-auto">
                <form class="text-dark" method="post" action="<?php echo e(route('discounts.store')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="name" name="discount_name" value="<?php echo e(old('discount_name')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="type" id="type">
                            ...
                            <option value="0" <?php if(old('type') == 0 && is_numeric(old('type'))): ?> selected <?php endif; ?>>Fixed</option>
                            <option value="1" <?php if(old('type') == 1): ?> selected <?php endif; ?>>Percent</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" id="amount" name="amount" value="<?php echo e(old('amount')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pange\Desktop\hudders-market\resources\views/discounts/create.blade.php ENDPATH**/ ?>